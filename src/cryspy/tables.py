...
def spacegroup(number):
    ...
    if number == 227:
        sg = geo.Spacegroup(geo.canonical, \
            [fs("{x,y,z}"), fs("{-x+3/4,-y+1/4,z+1/2}"), fs("{-x+1/4,y+1/2,-z+3/4}"), fs("{x+1/2,-y+3/4,-z+1/4}"), \
             fs("{z,x,y}"), fs("{z+1/2,-x+3/4,-y+1/4}"), fs("{-z+3/4,-x+1/4,y+1/2}"), fs("{-z+1/4,x+1/2,-y+3/4}"), \
             fs("{y,z,x}"), fs("{-y+1/4,z+1/2,-x+3/4}"), fs("{y+1/2,-z+3/4,-x+1/4}"), fs("{-y+3/4,-z+1/4,x+1/2}"), \
             fs("{y+3/4,x+1/4,-z+1/2}"), fs("{-x+1/2,z+3/4,y+1/4}"), fs("{y+1/4,-x+3/4,z+3/4}"), fs("{-y+3/4,x+3/4,z+1/4}"), \
